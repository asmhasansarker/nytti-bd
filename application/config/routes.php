...
$route['admin/student-details/(:any)'] = 'admin_profile/student_details/$1';
...
$route['admission_details/(:any)'] = 'home/admission_details/$1';
...
$route['save/student'] = 'Home/save_student';
$route['result'] = 'Home/student_result';
$route['result/student'] = 'Home/find_student_result';
