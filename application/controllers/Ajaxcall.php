        ...
        if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')){
            ...
            if(!empty($blog_data)){
                ...
                foreach($blog_data as $blog){
                    ...
                    $action = '<p class="actions_wrap"><a class="edit_blog btn_edit" data-id="'.$blog['id'].'" data-img="'.$blog['image'].'" data-des="'.html_escape($blog['description']).'"><i class="fa fa-edit""></i></a>
        ...
        if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')){
            ...
            if(!empty($batch_data)){
                ...
                foreach($batch_data as $batch){
                   $s_count = $this->db_model->countAll('students',array('batch_id'=>$batch['id']));
                    ...
                    if($role == '1'){
                            ...
                            <span class="tbl_action_drop" >
                				...
                				<ul class="tbl_action_ul">
                				    <li>
                				        <a href="'.base_url('admin/student-details/').$student['id'].'">
        ...
        if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')){
            ...
            if(!empty($videos)){
                ...
                foreach($videos as $vid){
                    ...
                    <a class="deleteData btn_delete" data-id="'.$vid['id'].'" data-table="video_lectures"><i class="fa fa-trash"></i></a>
                    <p class="actions_wrap"><a  class="edit_video_url btn_edit" title="Edit" data-id="'.$vid['id'].'" data-urle="'.$vid['url'].'"><i class="fa fa-edit"></i></a>
                    </p>';
                   ...
                   // $ins = $this->db_model->insert_data('video_lectures',$data_arr);
                    ...
                    for($i=0;$i<count($batch_data);$i++){
                        ...
                        $batch_id=$batch_data[$i];
                         $this->push_notification_android_video($batch_id,$title,$where,'',$match[1],$url,$data_arr['video_type']);
                    }
        ...
        if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')){
            ...
            if(!empty($doubts_data)){
                ...
                foreach($doubts_data as $key=>$value){
					...
					$action = '<p class="actions_wrap">
					<a class="'.$disable.' btn_view" data-doubtDate="'.$doubtDate.'" data-doubtTime="'.$doubtTime.'" data-doubtDes="'.$doubtDes.'" data-id="'.$value['doubt_id'].'" ><i class="fa fa-eye"></i></a>
                     </p>';
