        ...
        <div class="edu_admin_informationdiv edu_main_wrapper edu_add_student_wrapper">
            <form class="form" id="add_student_form" method="post" enctype="multipart/form-data" autocomplete="off" >
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="edu_title_wrapper">
                            <label>Roll/ID No</label>
	                       <input type="text" class="form-control" name="enrollment_id" placeholder="Roll/ID No" value="<?php echo !empty($student_data)?$student_data[0]['enrollment_id']:'';?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                           <label><?php echo html_escape($this->common->languageTranslator('ltr_grade'));?></label>
	                       <input type="text" class="form-control" name="grade" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_grade'));?>" value="<?php echo !empty($student_data)?$student_data[0]['grade']:'';?>">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            <label>Course Start Date<sup>*</sup></label>
                            <span class="select-date">
                                <input type="text" class="form-control chooseDate dobpicker require" name="course_start_date" placeholder="Start Date" value="<?php echo !empty($student_data)?date('d-m-Y',strtotime($student_data[0]['course_start_date'])):'';?>">
                            </span> 
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            <label>Course End Date<sup>*</sup></label>
                            <span class="select-date">
                                <input type="text" class="form-control chooseDate dobpicker require" name="course_end_date" placeholder="End Date" value="<?php echo !empty($student_data)?date('d-m-Y',strtotime($student_data[0]['course_end_date'])):'';?>">
                            </span> 
                        </div>
                    </div>
                </div>
