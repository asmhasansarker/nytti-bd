...
<div class="conatiner_certificate" id="printableArea">   
        ...
        <div class="edu_certifiate_inner">
           <div class="edu_certifiate_heading">
            ...
            <div class="certifiate_name_wrap">
                <h2 class="name_title"><?php echo html_escape($this->common->languageTranslator('ltr_student_name')); ?> </h2>
            </div>
           <p class="certificate_discrip"><?php echo $certificate_details[0]['description']?></p>
